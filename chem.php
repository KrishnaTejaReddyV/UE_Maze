...
$queryque="select Question from chem where Q_no='$qno'";
$question=implode(mysql_fetch_row(mysql_query($queryque)));
$queryopt1="select Option1 from chem where Q_no='$qno'";
$opt1=implode(mysql_fetch_row(mysql_query($queryopt1)));
$queryopt2="select Option2 from chem where Q_no='$qno'";
$opt2=implode(mysql_fetch_row(mysql_query($queryopt2)));
$queryopt3="select Option3 from chem where Q_no='$qno'";
$opt3=implode(mysql_fetch_row(mysql_query($queryopt3)));
$queryopt4="select Option4 from chem where Q_no='$qno'";
$opt4=implode(mysql_fetch_row(mysql_query($queryopt4))); 
$queryopt5="select Answer from chem where Q_no='$qno'";
$ans=implode(mysql_fetch_row(mysql_query($queryopt5))); 
$queryopt6="select Correct from chem where Q_no='$qno'";
$right=implode(mysql_fetch_row(mysql_query($queryopt6)));  
$queryque7="select Wrong from chem where Q_no='$qno'";
